...
-- STEP 3: PROCESS — Data Cleaning in SSMS
-- Source table: combined_trips (built via UNION ALL of the 12 monthly tables)



-- 3.1 Check for missing/incomplete values
...
-- 3.2 Remove rows with missing station data
...
-- 3.3 Check for duplicate ride_id values
...
-- 3.4 Validate categorical columns
...
-- 3.5 Build clean_combined_trips with new calculated columns
